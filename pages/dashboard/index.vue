        ...
        <div class="block mb-2">
          <div class="w-full lg:max-w-full lg:flex mb-4" v-for="campaign in campaigns.data.data" :key="campaign.id">
            <div
              ...
              :style="'background-color: #bbb; backround-position: center; background-image: url(\'' + $axios.defaults.baseURL + '/' + campaign.image_url + '\')'"
            >
            </div>
            <nuxt-link
              :to='`/dashboard/projects/${campaign.id}`'
              class="border-r w-full border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-8 flex flex-col justify-between leading-normal"
            >
              <div class="mb-8">
